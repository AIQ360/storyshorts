                      ...
                      <label className="space-y-2 text-sm">
                        ...
                        <input
                          ...
                          onChange={(e) => updateField("video_subject", e.target.value)}
                            placeholder="e.g. The rise of ancient Rome"
                          className="w-full rounded-xl border border-gray-200 px-3 py-2 outline-none ring-indigo-500 focus:ring-2"
                        />
                        <p className="text-xs text-gray-500">
                          Keep it short and specific. Backend handles script + search keywords.
                        </p>
                      </label>
                      ) : (
                        <label className="space-y-2 text-sm">
                          ...
                          <textarea
                            ...
                            rows={5}
                            placeholder="Describe the scene, perspective, emotion, and key moments you want in the final video..."
                            className="w-full rounded-xl border border-gray-200 px-3 py-2 outline-none ring-indigo-500 focus:ring-2"
                          />
                          <p className="text-xs text-gray-500">
                            Example: POV of Moses crossing the Red Sea, dramatic crowd reactions, rushing water, and a powerful cinematic tone.
                          </p>
                        </label>
                      )}
