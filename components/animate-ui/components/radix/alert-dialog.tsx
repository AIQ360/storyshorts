  ...
  return (
    <AlertDialogPortalPrimitive>
      ...
      <AlertDialogContentPrimitive
        className={cn(
          "bg-background fixed top-[50%] left-[50%] z-50 grid w-full max-w-[calc(100%-2rem)] translate-x-[-50%] translate-y-[-50%] gap-4 rounded-lg border border-gray-200/60 p-6 shadow-lg sm:max-w-lg",
          className,
        )}
        {...props}
      />
  ...
  return (
    <AlertDialogCancelPrimitive
      className={cn(
        ...
        "border-gray-200/60 rounded-full cursor-pointer",
        className,
      )}
      {...props}
    />
